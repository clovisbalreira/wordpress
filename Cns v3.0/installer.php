...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'cnsradiodecanoas30_349c103b0528984b4128_20220226122608_archive.zip';
	const ARCHIVE_SIZE		 = '85162769';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '349c103-26122608';
    const SECONDARY_PACKAGE_HASH = '8da3e27-26122608';
	const VERSION			 = '1.4.4';
