...
class SLGF {
	...
	?>
		<div class="">
			...
			<div class="update_pro_button">
				<a class="upg_anch" target="_blank" href="https://weblizar.com/lightbox-slider-pro/"><?php esc_html_e('Buy Now $12', WEBLIZAR_SLGF_TEXT_DOMAIN); ?></a>
			</div>
		</div>
	<?php
	}
	...
	public function slgf_generate_add_image_meta_box_function($post) { ?>
		...
		<a class="wrg-rate-us2" style="text-align:center; text-decoration: none;font:normal 30px;" href="http://wordpress.org/plugins/simple-lightbox-gallery/#reviews" target="_blank">
			<span class="dashicons dashicons-star-filled"></span>
			<span class="dashicons dashicons-star-filled"></span>
			<span class="dashicons dashicons-star-filled"></span>
			<span class="dashicons dashicons-star-filled"></span>
	...
	public function slgf_settings_meta_save($PostID) {
		if (isset($PostID) && isset($_POST['slgf_save_action']) && isset($_POST['security'])) {
			...
			$SLGF_Text_Color          = sanitize_hex_color($_POST['wl-text-color']);
			...
			$SLGF_open_link           = sanitize_option('SLGF_open_link', $_POST['SLGF_open_link']);
			...
			$SLGF_button_title        = sanitize_option('SLGF_button_title', $_POST['SLGF_button_title']);
			$SLGF_Light_Box           = sanitize_option('SLGF_Light_Box', $_POST['SLGF_Light_Box']);
			$SLGF_title_Color		  = sanitize_option('SLGF_title_Color', $_POST['SLGF_title_Color']);
