...
class Sonaar_Music_Public {
	...
	public function enqueue_styles() {
		...
		function sr_generateTypoStyle($typoSettings, $selector) { //convert typography setting to css line style
			$cssLines = '';
			$cssLines .= ( isset($typoSettings['font-family']) && $typoSettings['font-family'] !== '' )? sr_addFontStyle( $typoSettings['font-family'], $selector ) :'';
		...
		if( isset($font['font-family']) && $font['font-family'] !== ''){
			$data .= sr_addFontStyle( $font['font-family'], '.iron-audioplayer  .playlist .audio-track, .iron-audioplayer .track-title, .iron-audioplayer .album-store, .iron-audioplayer  .playlist .track-number, .iron-audioplayer .sr_it-playlist-title, .iron-audioplayer[data-playertemplate="skin_boxed_tracklist"] .track-title');
		}
		$data .= (  isset($font['font-size']) && $font['font-size'] !== '' )? '.iron-audioplayer  .playlist .audio-track, .iron-audioplayer .track-title, .iron-audioplayer .album-store, .iron-audioplayer  .playlist .track-number, .iron-audioplayer .sr_it-playlist-title, .iron-audioplayer[data-playertemplate="skin_boxed_tracklist"] .track-title{ font-size:' . $font['font-size'] . ';}' :'';
		$data .= ( isset($font['color']) && $font['color'] !== '' )? '.iron-audioplayer  .playlist .audio-track, .iron-audioplayer .track-title, .iron-audioplayer .album-store, .iron-audioplayer  .playlist .track-number, .iron-audioplayer .sr_it-playlist-title, .iron-audioplayer[data-playertemplate="skin_boxed_tracklist"] .track-title, .sr-playlist-item .srp_noteButton{ color:' . $font['color'] . ';}' :'';

		if( isset($fontTitle['font-family']) && $fontTitle['font-family'] !== ''){
			$data .= sr_addFontStyle( $fontTitle['font-family'], '.iron-audioplayer .sr_it-playlist-title, .iron-audioplayer[data-playertemplate="skin_boxed_tracklist"] .album-title, .iron-audioplayer[data-playertemplate="skin_boxed_tracklist"] .track-title' );
		}
		...
		if( isset($fontdate['font-family']) && $fontdate['font-family'] !== ''){
			$data .= sr_addFontStyle( $fontdate['font-family'], '.iron-audioplayer .srp_subtitle' );
		}	
		...
		if ( function_exists( 'run_sonaar_music_pro' ) ){
			...
			if( isset($fontExcerpt['font-family']) && $fontExcerpt['font-family'] !== ''){
				$data .= sr_addFontStyle( $fontExcerpt['font-family'], '.srp_track_description' );
			}	
			...
			$data .= ( $sticky_player_featured_color !== '' )? '#sonaar-player .playlist .tracklist li.active, #sonaar-player .playlist .tracklist li.active a, #sonaar-player .playlist .title{color:' . $sticky_player_featured_color . ';}' : '';
			...
			$data .= ( $sticky_player_labelsandbuttons !== '' )? '#sonaar-player .playlist .track-number svg path, #sonaar-player .playlist .track-number svg rect, #sonaar-player .control rect, #sonaar-player .control path, #sonaar-player .control polygon, .volume .icon path, #sonaar-player .shuffle path{fill:' . $sticky_player_labelsandbuttons . ';}' : '';
			...
			$data .= sr_generateTypoStyle($ctaPopupFont, 'div#sonaar-modal, article.srp_note');
		...
		$data .= ( Sonaar_Music::get_option('music_player_featured_color', 'srmp3_settings_widget_player') !== '' )? '.iron-audioplayer  .playlist .audio-track path, .iron-audioplayer  .playlist .audio-track rect{fill:' . Sonaar_Music::get_option('music_player_featured_color', 'srmp3_settings_widget_player') . ';}' : '';
		$data .= ( Sonaar_Music::get_option('music_player_icon_color', 'srmp3_settings_widget_player') !== '' )? '.iron-audioplayer .control rect, .iron-audioplayer .control path, .iron-audioplayer .srp-play-button path, .iron-audioplayer .srp-play-button rect, .iron-audioplayer .control polygon{fill:' . Sonaar_Music::get_option('music_player_icon_color', 'srmp3_settings_widget_player') . ';}' : '';
		$data .= ( Sonaar_Music::get_option('music_player_icon_color', 'srmp3_settings_widget_player') !== '' )? '.iron-audioplayer .srp-play-button circle{stroke:' . Sonaar_Music::get_option('music_player_icon_color', 'srmp3_settings_widget_player') . ';}' : '';
		...
		$data .= ( Sonaar_Music::get_option('music_player_artwork_icon_color', 'srmp3_settings_widget_player') !== '' )? '.iron-audioplayer.sr_player_on_artwork .sonaar-Artwort-box .control rect, .iron-audioplayer.sr_player_on_artwork .sonaar-Artwort-box .control path, .iron-audioplayer.sr_player_on_artwork .sonaar-Artwort-box .control polygon{fill:' . Sonaar_Music::get_option('music_player_artwork_icon_color', 'srmp3_settings_widget_player') . ';}' : '';
