...
if ( $qry->have_posts() ) {
	while ( $qry->have_posts() ) {
		...
		$ep_explicit = (isset($album_tracks[0]['podcast_explicit_episode'])) ? $album_tracks[0]['podcast_explicit_episode'] : '';
		...
		$ep_block = (isset($album_tracks[0]['podcast_itunes_notshow'])) ? $album_tracks[0]['podcast_itunes_notshow'] : '';
		if ( ! empty( $ep_block ) ) {
		...
		$itunes_episode_number = $album_tracks[0]['podcast_itunes_episode_number'];
		$itunes_season_number  = $album_tracks[0]['podcast_itunes_season_number'];
