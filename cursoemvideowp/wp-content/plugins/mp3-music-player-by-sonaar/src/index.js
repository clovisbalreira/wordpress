(function (wp) {
    ...
    registerBlockType('sonaar/sonaar-block', {
        ...
        edit(props) {
                    ...
                    <>
                        ...
                        {isOpen && (
                            <Modal title="Pro Feature" onRequestClose={closeGoProModal}>
                                ...
                                <Button href="https://sonaar.io/free-mp3-music-player-plugin-for-wordpress/?utm_source=Sonaar+Music+Free+Plugin&utm_medium=plugin#pricing" target="_blank" isPrimary>
                                    Learn More
                                </Button>
                            </Modal>
                        )}
            ...
            function style_changes(newValue = false) {
                ...
                if (!playlist_hide_artwork) {
                    if (player_layout == 'skin_boxed_tracklist') {
                        boxed_artwork_width = setNewValue({ boxed_artwork_width }, newValue);
                ...
                title_align = setNewValue({ title_align }, newValue);
                ...
                title_indent = setNewValue({ title_indent }, newValue);
                ...
                audio_player_artwork_controls_color = setNewValue({ audio_player_artwork_controls_color }, newValue);
                ...
                if (sr_player_on_artwork) {
                    audio_player_artwork_controls_scale = setNewValue({ audio_player_artwork_controls_scale }, newValue);
                ...
                button_border_color = setNewValue({ button_border_color }, newValue);
                ...
                if (sr_player_on_artwork && !playlist_hide_artwork && playlist_show_playlist && move_playlist_below_artwork) {
                    artwork_align = setNewValue({ artwork_align }, newValue);
                ...
                track_title_fontsize = setNewValue({ track_title_fontsize }, newValue);
                ...
                audio_player_controls_color = setNewValue({ audio_player_controls_color }, newValue);
                ...
                title_soundwave_fontsize = setNewValue({ title_soundwave_fontsize }, newValue);
                ...
                track_title_color = setNewValue({ track_title_color }, newValue);
                ...
                tracklist_hover_color = setNewValue({ tracklist_hover_color }, newValue);
                ...
                tracklist_active_color = setNewValue({ tracklist_active_color }, newValue);
                ...
                metadata_color = setNewValue({ metadata_color }, newValue);
                ...
                track_publish_date_fontsize = setNewValue({ track_publish_date_fontsize }, newValue);
                ...
                track_publish_date_color = setNewValue({ track_publish_date_color }, newValue);
                ...
                tracklist_bg = setNewValue({ tracklist_bg }, newValue);
                if (tracklist_bg != '') {
                ...
                player_bg = setNewValue({ player_bg }, newValue);
                if (player_bg != '') {
                ...
                button_text_color = setNewValue({ button_text_color }, newValue);
                ...
                background_color = setNewValue({ background_color }, newValue);
                ...
                button_hover_color = setNewValue({ button_hover_color }, newValue);
                ...
                button_background_hover_color = setNewValue({ button_background_hover_color }, newValue);
                ...
                button_hover_border_color = setNewValue({ button_hover_border_color }, newValue);
                ...
                title_soundwave_color = setNewValue({ title_soundwave_color }, newValue);
                ...
                description_color = setNewValue({ description_color }, newValue);
                ...
                externalLinkButton_bg = setNewValue({ externalLinkButton_bg }, newValue);
                ...
                tracklist_icons_color = setNewValue({ tracklist_icons_color }, newValue);
                ...
                tracklist_icons_size = setNewValue({ tracklist_icons_size }, newValue);
                ...
                jQuery('#block-' + clientId + ' .iron-audioplayer .track-number svg').css({ 'width': tracklist_controls_size + 'px', 'height': tracklist_controls_size + 'px' });
                ...
                jQuery('#block-' + clientId + ' .iron-audioplayer .player .control').css({ 'top': audio_player_controls_spacebefore + 'px', 'position': 'relative' });
            }
                    ...
                    createElement(PanelBody, {
                        ...
                        (playlist_source == 'from_cat') && (show_cat_description) && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ description_color: value });
                            }
                        }),
                        ...
                        createElement(SelectControl, {
                            ...
                            value: player_layout,
                            onChange: player_layout => {
                                setAttributes({ player_layout: player_layout });
                                ironAudioplayersLoaded = false
                                setIronAudioplayers;
                                style_load = false;
                            }
                    ...
                    !playlist_hide_artwork && createElement(PanelBody, {
                        ...
                        (player_layout == 'skin_float_tracklist') && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ artwork_width: value });
                            }
                        }),
                        (player_layout == 'skin_boxed_tracklist') && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ boxed_artwork_width: value });
                        ...
                        (player_layout == 'skin_float_tracklist') && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ artwork_padding: value });
                            }
                        }),
                        createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ artwork_radius: value });
                            }
                        }),
                        ...
                        (sr_player_on_artwork) && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ audio_player_artwork_controls_color: value });
                            }
                        }),
                        (sr_player_on_artwork) && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ audio_player_artwork_controls_scale: value });
                            }
                        }),
                    ),
                    playlist_show_playlist && createElement(PanelBody, {
                        ...
                        (sr_player_on_artwork) && (!playlist_hide_artwork) && playlist_show_playlist && (move_playlist_below_artwork) && createElement(SelectControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ artwork_align: value });
                            }
                        }),
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ tracklist_bg: value });
                            }
                        }),
                        createElement(RangeControl, {
                        ...
                        (player_layout != 'skin_boxed_tracklist') && createElement('hr', {}),
                        (player_layout != 'skin_boxed_tracklist') && createElement(RichText.Content, {
                            tagName: 'label',
                            className: 'components-base-control__label sonaar-block-label',
                        ...
                        (player_layout != 'skin_boxed_tracklist') && (!title_btshow) && createElement(SelectControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ title_align: value });
                            }
                        }),
                        ...
                        (player_layout != 'skin_boxed_tracklist') && (!title_btshow) && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ title_indent: value });
                            }
                        }),
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ track_title_color: value });
                            }
                        }),
                        createElement(RichText.Content, {
                            tagName: 'label',
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ tracklist_hover_color: value });
                            }
                        }),
                        createElement(RichText.Content, {
                            tagName: 'label',
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ tracklist_active_color: value });
                            }
                        }),
                        createElement(RichText.Content, {
                            tagName: 'label',
                        ...
                        createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ track_title_fontsize: value });
                            }
                        }),
                        createElement(RangeControl, {
                        ...
                        (show_track_publish_date != 'false') && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ track_publish_date_fontsize: value });
                            }
                        }),
                        ...
                        (show_track_publish_date != 'false') && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ track_publish_date_color: value });
                            }
                        }),
                        ...
                        (!hide_trackdesc) && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ trackdesc_fontsize: value });
                            }
                        }),
                        ...
                        (!hide_trackdesc) && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ trackdesc_color: value });
                            }
                        }),
                        ...
                        (!play_pause_bt_show) && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                jQuery('#block-' + clientId + ' .iron-audioplayer .track-number svg').css({ 'width': value + 'px', 'height': value + 'px' });
                                jQuery('#block-' + clientId + ' .iron-audioplayer .track-number').css('padding-left', paddingValue + 'px');
                            }
                        }),
                        ...
                        (!hide_track_market) && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ tracklist_icons_color: value });
                            }
                        }),
                        ...
                        (!hide_track_market) && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ tracklist_icons_size: value });
                            }
                        }),
                    ...
                    createElement(PanelBody, {
                        ...
                        createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ metadata_fontsize: value });
                            }
                        }),
                        createElement(RichText.Content, {
                            tagName: 'label',
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ metadata_color: value });
                            }
                        }),
                        createElement(SelectControl, {
                            label: __('Show Publish Date', 'sonaar-music'),
                    ...
                    createElement(PanelBody, {
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ externalLinkButton_bg: value });
                            }
                        }),
                        createElement(ToggleControl, {
                            label: __('Hide Heading', 'sonaar-music'),
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ button_text_color: value });
                            }
                        }),
                        createElement(RichText.Content, {
                            tagName: 'label',
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ background_color: value });
                            }
                        }),
                        createElement(RichText.Content, {
                            tagName: 'label',
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ button_hover_color: value });
                            }
                        }),
                        createElement(RichText.Content, {
                            tagName: 'label',
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ button_background_hover_color: value });
                            }
                        }),
                        ...
                        (button_border_style != 'none') && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ button_border_color: value });
                            }
                        }),
                        ...
                        (button_border_style != 'none') && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ button_hover_border_color: value });
                            }
                        }),
                        (button_border_style != 'none') && createElement(RangeControl, {
                    ...
                    (!playlist_show_soundwave) && createElement(PanelBody, {
                        ...
                        (!hide_player_title) && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                is_style_loaded;
                                setAttributes({ title_soundwave_fontsize: value });
                                style_changes({ title_soundwave_fontsize: value });
                            }
                        }),
                        ...
                        (!hide_player_title) && createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ title_soundwave_color: value });
                            }
                        }),
                        ...
                        createElement(ColorPalette, {
                            ...
                            onChange: value => {
                                ...
                                style_changes({ audio_player_controls_color: value });
                            }
                        }),
                        (!progressbar_inline) && createElement(RangeControl, {
                            ...
                            onChange: value => {
                                ...
                                jQuery('#block-' + clientId + ' .iron-audioplayer .player .control').css({ 'top': value + 'px', 'position': 'relative' });
                            }
                        }),
