...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'cnsradiodecanoas_2bbaf10c0228f09d2653_20220212033950_archive.zip';
	const ARCHIVE_SIZE		 = '80707040';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2bbaf10-12033950';
    const SECONDARY_PACKAGE_HASH = '6ab0fb4-12033950';
	const VERSION			 = '1.4.4';
