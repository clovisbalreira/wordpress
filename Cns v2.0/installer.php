...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'cnsradiodecanoas_320bea1b49c41db53139_20220221083740_archive.zip';
	const ARCHIVE_SIZE		 = '84044109';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '320bea1-21083740';
    const SECONDARY_PACKAGE_HASH = '1f071e1-21083740';
	const VERSION			 = '1.4.4';
